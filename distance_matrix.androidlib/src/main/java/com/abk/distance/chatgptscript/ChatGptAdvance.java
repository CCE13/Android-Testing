...
public class ChatGptAdvance {
    ...
    public static List<ChatFunction> functionsList = new ArrayList<>();
    FunctionExecutor functionExecutor = new FunctionExecutor(functionsList);

    public ChatMessage responseMessage;


    public ChatGptAdvance(){
